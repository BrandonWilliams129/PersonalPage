...
const projects: Project[] = [
  {
    title: 'Cat or Capital',
    description: 'A web game where you guess if a name is a cat name or a world capital. Inspired by fun trivia and ambiguous names! Try to beat your high score.',
    imageSrc: '/games/cat-or-capital/images/CatCapital.png',
    tags: ['JavaScript', 'HTML', 'CSS', 'Quiz Game'],
    links: {
      play: '/games/cat-or-capital/cat-or-capital.html'
    },
    status: 'Completed',
    date: '4-15-2025'
  },
